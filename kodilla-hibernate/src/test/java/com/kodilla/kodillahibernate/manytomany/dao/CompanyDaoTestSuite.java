...
class CompanyDaoTestSuite {
    ...
    public void testFindCompaniesEmployeeQueries() {
        ...
        //When
        List<Company> companyNames = companyDao.retrieveCompaniesWithNameStarting("Dat");
        List<Employee> employeeNames = employeeDao.retrieveEmployeeWithName("Smith");

        //Then

        try {
            Assertions.assertEquals(1, companyNames.size());
            Assertions.assertEquals(1, employeeNames.size());
        } finally {
            //CleanUp
